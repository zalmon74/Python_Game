...
START_GAME = 0 # Константа, отвечающая за начало игры против бота
START_LOCAL_GAME = 1 # Константа, отвечающая за начало игры по локальной сети
CREATE_LOCAL_GAME = 3 # Константа, отвечающая за создание игры по лок. сети
# Константа, отвечающая за подключение к игре по локальной сети
CONNECTION_LOCAL_GAME = 4                 
EXIT_GAME = 5 # Константа, отвечающая за выход с игры
...
TIMEOUT_LOCAL_GAME =  2*60 # 2 минуты
# Размер буфера для передачи данных через сокет
BUF_SIZE_SOCKET = 128